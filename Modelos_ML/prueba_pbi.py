...
data_cleaned = pd.read_excel("C:/Users/Daniel Martinez/Desktop/Tesis de Grado Maestria/Exploración/Analisis De Aceite Flotas Mineras.xlsx")
...
df_test = pd.read_csv("C:/Users/Daniel Martinez/Desktop/Tesis de Grado Maestria/Exploración/Analisis De Aceite Flotas Mineras_test.csv")
...
X_flota1 = df_flota1_test.drop(columns=['Assigned Condition Rating',
                             ...
                             'Fault Effect',
                             'SACODE_Salud', 'SACODE_Desgaste',
                             'SACODE_Contaminacion', 'SACODE_General',
                             'Flota', 'Rule Based Rating'],  errors='ignore')
...
# ==============================================================================
# CARGA DE MODELOS — ✅ Corregido: + en vez de /
# ==============================================================================

MODEL_DIR = "C:/Users/Daniel Martinez/Desktop/Tesis de Grado Maestria/Modelos_ML/modelo_oilsense"

pipeline_cargado = joblib.load(MODEL_DIR + "/pipeline_lightgbm_calibrado.pkl")
encoder_cargado  = joblib.load(MODEL_DIR + "/label_encoder.pkl")
limites_cargados = joblib.load(MODEL_DIR + "/limites_sacode_flota.pkl")

with open(MODEL_DIR + "/config_modelo.json", 'r', encoding='utf-8') as f:
    config = json.load(f)
...
# ==============================================================================
# CARGA MODELO SEVERIDAD — ✅ Corregido: + en vez de /
# ==============================================================================

MODEL_DIR_severidad = "C:/Users/Daniel Martinez/Desktop/Tesis de Grado Maestria/Modelos_ML/modelo_oilsense_severidad"

pipeline_cargado_severidad  = joblib.load(MODEL_DIR_severidad + "/pipeline_randomforest_calibrado.pkl")
encoder_cargado_severidad   = joblib.load(MODEL_DIR_severidad + "/label_encoder.pkl")
limites_cargados_severidad  = joblib.load(MODEL_DIR_severidad + "/limites_sacode_flota.pkl")

with open(MODEL_DIR_severidad + "/config_modelo.json", 'r', encoding='utf-8') as f:
    config = json.load(f)
